...
class Methods
{
    public:
        ...
        static void VPush(const std::string& key, const std::string& value);

        static void Incr(const std::string& key);

        static void Decr(const std::string& key);

        static void HDel(const std::string& key, const std::string& hesh);

        static void LDel(const std::string& key, const std::string& value);

        static void LGet(const std::string& key);

        static void Find(const std::string& key);
        
        static void Search(const std::string& key);
