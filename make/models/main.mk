...
std-header:
	@echo " "
	@echo "· Building beryl-bench.          "
	@echo " "

finishmessage: target
	@echo " "
	@echo "* beryl-bench compiled."
	@echo "* To install beryl-bench, type: 'make install'"
...
install: target
	...
	-$(INSTALL) -g @GID@ -o @UID@ -m $(INSTMODE_BIN) "$(BUILDPATH)/bin/beryl-bench" .
	-$(INSTALL) -g @GID@ -o @UID@ -m $(INSTMODE_TXT) @CONFIGURE_DIRECTORY@/beryl-bench.1 $(MANPATH) 2>/dev/null
	...
	@echo ""
	@echo "· beryl-bench is now installed."
	@echo ""
	@echo 'You need to create a configuration file:' $(CONPATH)/beryl-bench.conf
	@echo 'Feel free to check our config examples:' $(EXAPATH)
	@echo "" 	
	@echo '· To start the client, run:'  ./beryl-bench
	@echo ""
...
clean:
	@echo "Cleaning           "
	-rm -f "$(BUILDPATH)/bin/beryl-bench" "$(BUILDPATH)/include" "$(BUILDPATH)/real.mk"
